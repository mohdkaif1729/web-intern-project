  ...
  return (
    <section className='mt-10 w-[75%] m-auto'>
      <div className='w-[70%] m-auto flex flex-col gap-6 items-center mt-20 '>
        ...
        <div>
          <input type="text" placeholder='Enter Your Email' className='bg-[#F8F8F8] px-10 py-2 rounded-md'  />
          <button className='px-5 py-2 bg-[#FD6F00] font-bold rounded-md text-white ml-5' >Contact Me</button>
        </div>
      </div>
    </section>
  )
