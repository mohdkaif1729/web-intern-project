...
function Section3() {
  return (
    <section className='flex flex-col gap-5 items-center justify-center mt-20'>
      ...
      <p className='text-center w-50%'>Lorem ipsum dolor sit amet consectetur. Tristique amet sed massa nibh lectus netus in. Aliquet donec morbi convallis pretium</p>
